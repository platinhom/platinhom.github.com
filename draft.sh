...
touch ${blogdir}/_drafts/"${today}-${title}.md"
echo "---" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "layout: post" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "title: $title" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "date: $nowGMT" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "categories: $category" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "tags: $tag" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "---" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "" >> ${blogdir}/_drafts/"${today}-${title}.md"
echo "------" >> ${blogdir}/_drafts/"${today}-${title}.md"
...
if $(which sl);then
	sl ${blogdir}/_drafts/"${today}-${title}.md" &
else
	subl ${blogdir}/_drafts/"${today}-${title}.md" &
fi
